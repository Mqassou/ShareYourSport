...
/* 
        try {
            ...
            connection.setRequestProperty("OBJET", "login");
        ...
        try{
            ...
            for(int i=0;i<jArray.length();i++){
                ...
                if(json_data.getString("value").equals("true"))
                {
                    Toast.makeText(getBaseContext(), "Connexion à la BDD réussie", Toast.LENGTH_LONG).show();

                }
                else
                {
                    Toast.makeText(getBaseContext(), "Echec de la connexion à la BDD ", Toast.LENGTH_LONG).show();
                }
            }
        }
